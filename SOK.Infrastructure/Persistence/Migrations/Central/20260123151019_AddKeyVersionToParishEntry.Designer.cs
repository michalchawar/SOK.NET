...
namespace SOK.Infrastructure.Persistence.Migrations.Central
{
    ...
    [Migration("20260123151019_AddKeyVersionToParishEntry")]
    partial class AddKeyVersionToParishEntry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SOK.Domain.Entities.Central.ParishEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SOK.Domain.Entities.Central.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SOK.Domain.Entities.Central.User", null)
                        .WithMany()
